...
$string['adminpage_item_tags'] = 'Tags';
...
$string['cachedef_sitemapxml'] = 'Cache XML';
...
$string['settings_includetags'] = 'Include tags';
$string['settings_includetags_desc'] = 'Include Moodle tags that are assigned to at least one item.';
